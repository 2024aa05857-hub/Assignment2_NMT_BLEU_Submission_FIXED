...
def _sacre_tokenize(text: str) -> List[str]:
    ...
    Compatible with multiple sacrebleu versions.
    Returns a list of tokens.
    """
    text = text.strip()

    # Newer sacrebleu versions: Tokenizer13a is available as a class
    try:
    ...
    # Older sacrebleu versions: TOKENIZERS dict existed
    try:
    ...
    # Final fallback: simple whitespace split (won't match standard BLEU perfectly)
    return text.split()
